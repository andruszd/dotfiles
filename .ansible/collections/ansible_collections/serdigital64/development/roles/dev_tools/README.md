...
The **dev_tools** Ansible-Role is part of the [A:Platform64](https://aplatform64.readthedocs.io) project and is available in the [development](../collections/development.md) Ansible-Collection.
...
```yaml
- name: "Example: Install development tools"
  vars:
    dev_tools:
      resolve_prereq: true
      deploy: true
